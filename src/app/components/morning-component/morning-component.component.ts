...
@Component({
  selector: 'app-morning-component',
  imports: [CommonModule],
  templateUrl: './morning-component.component.html',
  styleUrl: './morning-component.component.css'
})

export class MorningComponentComponent {
  azkar = [
    {
      id: 1,
      ...
      count: 1,
      start: 'أَعُوذُ بِاللهِ مِنْ الشَّيْطَانِ الرَّجِيمِ',
      originCount: 1
    },
    {
      id: 2,
...
قُلْ أَعُوذُ بِرَبِّ ٱلْفَلَقِ، مِن شَرِّ مَا خَلَقَ، وَمِن شَرِّ غَاسِقٍ إِذَا وَقَبَ، وَمِن شَرِّ ٱلنَّفَّٰثَٰتِ فِى ٱلْعُقَدِ، وَمِن شَرِّ حَاسِدٍ إِذَا حَسَدَ `,
  ...
  reset(zikr: any) {
    zikr.count= this.azkar.find(x=>x.id==zikr.id)?.originCount
  }
}
